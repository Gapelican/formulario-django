...
class PassagemForms(forms.ModelForm):
    ...
    class Meta:
        model = Passagem
        fields = '__all__'
        labels = {'data_ida':'Data de ida', 'data_volta': 'Data de volta', 'informacoes':'informações', 'classe_viagem':'Classe da viagem'}
        widgets = {
            'data_ida': DatePicker(),
    ...
    def clean(self):
        ...
        campo_tem_algum_numero(destino, 'origem', lista_de_erros)
